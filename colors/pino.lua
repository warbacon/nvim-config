...
local colors = {
    ...
    Title = { fg = palette.love, bold = true },
    Type = { italic = true },

    -- Syntax: Treesitter / Semantic
    ["@markup.heading.1.markdown"] = { fg = palette.love },
    ["@markup.heading.2.markdown"] = { fg = palette.gold },
    ["@markup.heading.3.markdown"] = { fg = palette.leaf },
    ["@markup.heading.4.markdown"] = { fg = palette.foam },
    ["@markup.heading.5.markdown"] = { fg = palette.iris },
